...
def islemkali():
	...
	gorsellik=""
	while True:
		giriwkali=input("""\x1b[0;30;33m1) Add Kali Linux source.list
2) Update 
3) Kali Linux Tools
4) Help
...
$$ |\$$\   $$  _$$ |$$ |$$ |           $$ |      $  |   $ | $ |    $ | $$ |     $ |
$$ | \$$\  \$$$$$$ |$$ |$$ |           $$ |      \$$$$$$$ | \$$$$$$$ | $$ |\$$$$  |
\__|  \__\  \______|\__|\__|           \__|       \_______|  \_______| \__| \_____| v1.0{}""".format(icerik1,icerik2)
...
--------------------------------------------------------------------------------------------\x1b[0m  \x1b[0;30;32m""".format(kaliresim)
#-----------------------------------------------------------------
